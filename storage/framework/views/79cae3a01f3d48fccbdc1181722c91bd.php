            ...
            <tbody>
                <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(date('d F, Y',strtotime($todo->tgl_awal))); ?></td>
                        <td><?php echo e(date('d F, Y',strtotime($todo->tgl_akhir))); ?></td>
                        <td><a href="/update-status/<?php echo e($todo->id); ?>/<?php echo e($todo->status == 'Belum' ? 'Sudah' : 'Belum'); ?>" class="text-decoration-none badge rounded-pill text-bg-<?php echo e($todo->status == 'Belum' ? 'warning' : 'success'); ?>"><?php echo e($todo->status); ?></a></td>
                        <td>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status">
                                                <option value="Belum" <?php if($todo->status == 'Belum'): ?> selected <?php endif; ?>>Belum</option>
                                                <option value="Sudah" <?php if($todo->status == 'Sudah'): ?> selected <?php endif; ?>>Sudah</option>
                                            </select>                                            
                                        </div>
                                    </div>
...
</html><?php /**PATH C:\laragon\www\todo\resources\views/todo.blade.php ENDPATH**/ ?>