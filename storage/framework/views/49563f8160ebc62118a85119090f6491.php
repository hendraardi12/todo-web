            ...
            <tbody>
                <?php $__currentLoopData = $todos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><a href="/update-status/<?php echo e($todo->id); ?>/<?php echo e($todo->status == 0 ? 1 : 0); ?>" class="btn btn-sm btn-<?php echo e($todo->status == 0 ? 'warning' : 'success'); ?>"><?php echo e($todo->status == 0 ? 'Belum' : 'Sudah'); ?></a></td>
                        <td>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status">
                                                <option value="0" <?php if($todo->status == 0): ?> selected <?php endif; ?>>Belum</option>
                                                <option value="1" <?php if($todo->status == 1): ?> selected <?php endif; ?>>Sudah</option>
                                            </select>                                            
                                        </div>
                                    </div>
...
</html><?php /**PATH C:\laragon\www\todo-web\resources\views/index.blade.php ENDPATH**/ ?>